...
public class TankMechanumControlSchemeFixLeft implements JoystickDriveControlScheme {
    ...
    public TankMechanumControlSchemeFixLeft(Gamepad gamepad)
    {
        this.gamepad = gamepad;
        this.motorDirection = MotorDirection.CANONICAL;
    }

    public TankMechanumControlSchemeFixLeft(Gamepad gamepad, MotorDirection motorDirection)
    {
        this.gamepad = gamepad;
